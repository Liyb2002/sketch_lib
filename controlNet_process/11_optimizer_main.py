...
from constraints_optimization.vis import visualize_initial_bboxes  # Import the new visualization function
...
def main():
    ...
    # Call the visualization function before starting optimization
    print("\n[VIS] Visualizing initial bounding boxes for each label...")
    visualize_initial_bboxes(
