...
def save_face_edit_change_json(aep_dir: str, counter: int, face_edit_change: Dict[str, Any]) -> str:
    """Save face_edit_change to {counter}_face_edit_change.json"""
...
def find_next_face_edit_change_and_save_and_vis(
    ...
    if connection_type == "attachment":
        ...
        fec = find_sym_and_containment_face(
            edit=edit,
            neighbor_before_obb=neighbor_before_obb,
            neighbor_after_obb=neighbor_after_obb,
